<template>
<uni-shadow-root class="weui-miniprogram-checkbox-group-checkbox-group"><checkbox-group :class="extClass" :wx-if="multi" @change="checkedChange">
    <slot></slot>
</checkbox-group>
<radio-group :class="extClass" wx-else @change="checkedChange">
    <slot></slot>
</radio-group></uni-shadow-root>
</template>

<script>
import MpCells from '../cells/cells.vue'
global['__wxVueOptions'] = {components:{'mp-cells': MpCells}}

global['__wxRoute'] = 'weui-miniprogram/checkbox-group/checkbox-group'
module.exports =
...
/******/ });
export default global['__wxComponents']['weui-miniprogram/checkbox-group/checkbox-group']
</script>
