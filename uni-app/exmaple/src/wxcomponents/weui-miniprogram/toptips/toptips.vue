<template>
<uni-shadow-root class="weui-miniprogram-toptips-toptips"><view :class="'weui-toptips '+(className)+' '+(extClass)+' '+(show ? 'weui-toptips_show' :  '')">
...
global['__wxRoute'] = 'weui-miniprogram/toptips/toptips'
module.exports =
...
/******/ });
export default global['__wxComponents']['weui-miniprogram/toptips/toptips']
</script>
