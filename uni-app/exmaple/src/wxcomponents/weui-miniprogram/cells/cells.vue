<template>
<uni-shadow-root class="weui-miniprogram-cells-cells"><view :class="(extClass)+' weui-cells__group '+(outerClass)+' '+(childClass)">
...
global['__wxRoute'] = 'weui-miniprogram/cells/cells'
module.exports =
...
/******/ });
export default global['__wxComponents']['weui-miniprogram/cells/cells']
</script>
