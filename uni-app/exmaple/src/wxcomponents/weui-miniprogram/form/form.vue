<template>
<uni-shadow-root class="weui-miniprogram-form-form"><view :class="extClass">
    <slot></slot>
...
global['__wxRoute'] = 'weui-miniprogram/form/form'
module.exports =
...
/***/ })
/******/ ]);
export default global['__wxComponents']['weui-miniprogram/form/form']
</script>
